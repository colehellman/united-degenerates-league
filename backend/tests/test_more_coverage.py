...
@pytest.mark.asyncio
async def test_join_full_competition(
    client: AsyncClient,
    test_user: User,
    second_user: User,
...
@pytest.mark.asyncio
async def test_update_competition_as_non_admin(
    client: AsyncClient, second_user: User, active_competition: Competition
):
...
@pytest.mark.asyncio
async def test_delete_competition_as_league_admin(
...
@pytest.mark.asyncio
async def test_create_pick_not_participant(
    client: AsyncClient, second_user: User, active_competition: Competition
):
...
@pytest.mark.asyncio
async def test_create_pick_for_started_game(
    client: AsyncClient,
    test_user: User,
    active_competition: Competition,
    test_teams,
...
@pytest.mark.asyncio
async def test_create_pick_exceeds_daily_limit(
    client: AsyncClient,
    test_user: User,
    active_competition: Competition,
    test_teams,
...
@pytest.mark.asyncio
async def test_create_fixed_selection_for_started_competition(
    client: AsyncClient,
    test_user: User,
...
@pytest.mark.asyncio
async def test_create_fixed_selection_exceeds_limit(
    client: AsyncClient,
    test_user: User,
    upcoming_fixed_comp: Competition,
    test_teams,
...
@pytest.mark.asyncio
async def test_create_fixed_selection_with_both_team_and_golfer(
    client: AsyncClient,
    test_user: User,
    upcoming_fixed_comp: Competition,
    test_teams,
...
@pytest.mark.asyncio
async def test_approve_join_request_as_non_admin(
    client: AsyncClient,
    second_user: User,
...
@pytest.mark.asyncio
async def test_approve_already_approved_join_request(
    client: AsyncClient,
    test_user: User,
    second_user: User,
    approval_competition: Competition,
...
@pytest.mark.asyncio
async def test_audit_logs_with_filters(
    client: AsyncClient, test_user: User, db_session: AsyncSession, active_competition: Competition
):
...
@pytest.mark.asyncio
async def test_get_leaderboard_not_participant(
    client: AsyncClient,
    second_user: User,
    active_competition: Competition,
    db_session: AsyncSession,
...
@pytest.mark.asyncio
async def test_get_leaderboard_with_sort(
    client: AsyncClient, test_user: User, active_competition: Competition, participant: Participant
):
